...
rmarkdown::render("./static/slides/03_analysis/index.Rmd")
xaringan::inf_mr()
```
...
| :-- | :----- | :---: | :------------------------------------------------------------------------- | :------------------------------- |
| 12  | Lunes  | 10/16 | Metodología 2: Análisis acústico - Praat.                                  |                                  |
| 13  | Jueves | 10/19 | Adquisición sequencial.                                                    | PB: cap. 7, 145-155.             |
| 14  | Lunes  | 10/23 | Adquisición sequencial (cont).                                             | PB: cap. 7, 155-164.             |
| 15  | Jueves | 10/26 | HLS - clase cancelada                                                      |                                  |
| 16  | Lunes  | 10/30 | Adquisición sequencial - producción. Pres. 3a.                             | ART: Knightly et al. (2003).     |
| 17  | Jueves | 11/02 | Adquisición sequencial - percepción. Pres. 3b.                             | ART: Pallier et al. (1997).      |
| 18  | Lunes  | 11/06 | Presentación del Dr. Miquel Simonet.                                       |                                  |
...
```{r, echo=FALSE, output='hide', fig.retina=2, fig.width=8, fig.height=6}
library(lingStuff)
vowel_plot(data = vowel_data, vowel = 'vowel', f1 = 'f1', f2 = 'f2')
```
...
- La edad a la que se adquiere una lengua tiene consecuencias con respecto al desarrollo de las distintas destrezas en la L2 (i.e., *ultimate attainment*)

--

- En general, se ha observado que los niños aprenden una L2 con más facilidad que los adultos
	- Con frecuencia los adultos tienen dificultades con aspectos 'fáciles', incluso después de contar con mucha experiencia en la L2
	- Ej. El género para aprendices del español

--

- Hay décadas de investigaciones que intentan explicar la relación  
entre la edad y *ultimate attainment*
...
<div align="center">
<video width="600" height="452" controls>
  <source src="./assets/vids/genie.mp4" type="video/mp4">
  <source src="./assets/vids/genie.ogg" type="video/ogg">
...
---
background-image: url(https://bilingualismucsd.wikispaces.com/-/Article%20Wiki%20SP15/Team%2013/file/view/11166021_939552599418889_1172877532_n.jpg/548355712/405x470/11166021_939552599418889_1172877532_n.jpg)
background-size: contain
...
<div style="float:right">
  <img width="50" src="../../img_slides/hfill.png">
  <img src="../../img_slides/confundido.png">
</div>
